...
class WheelOfFortune extends Component {
  constructor(props) {
    super(props);
   // alert("rwd"+JSON.stringify(this.props.wheelOptions));
    this.state = {
      enabled: false,
      started: false,
      finished: false,
  ...
  prepareWheel = () => {
    ...
    this.winner = this.props.wheelOptions.winner ?? Math.floor(Math.random() * this.numberOfSegments);
   ...
   _onPress = () => {
    ...
    Animated.timing(this._angle, {
      ...
      if (this.props.getWinner) {
        ...
        this.props.wheelOptions?.getWinner?.(
          ...
          <Image
            source={
              this.props.wheelOptions.knobSource
                ? this.props.wheelOptions.knobSource
                : require('../assert/images/knob.png')
            }
