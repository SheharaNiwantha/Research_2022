       ...
       // closeBin();
        ...
        trashInfo.map((item) => {
            ...
            if (item.name == trashName) {
                ...
                //alert("diff "+diff);
                setMyPoint((diff * parseInt(item.ponit))/1000);
                var today = new Date();
                ...
                var bt = {
                    ...
                    "weight": diff,
                    "date": today,
                    "point": (diff * parseInt(item.ponit))/1000,
            ...
            <View style={style.container}>
                <View style={style.holder}>
                    <View style={style.detailHolder}>
                        ...
                        <Text style={style.infoShow}>{global.curretbinInfos.weight}</Text>
                    </View>
                    <View style={style.detailHolder}>
                    ...
                    <View >
                        <SelectList style={style.detailHolder} dropdownTextStyles={{color : '#000'}} inputStyles={{color : '#000'}} setSelected={setTrashType} data={trashList} onSelect={() => {}} />
                    </View>
